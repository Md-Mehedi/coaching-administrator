...
export const csvTemplate = {
  ...
  enrollProgram: ["Student ID"],
};

/**
 * It takes a template and a data array and returns an array
 * of objects with the template as the keys
...
export function parseCSV(template: string[], data: string[][]) {
  ...
  return data.map((row) => {
    ...
    console.log("in csv parse", object);
    return object;
  });
}
