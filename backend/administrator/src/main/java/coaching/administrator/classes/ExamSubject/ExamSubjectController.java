...
public class ExamSubjectController {
    ...
    // subjectService.getSubjectById(examSubject.getSubject().getId());
    // if (fetchedExam == null) {
    ...
    // service.getExamSubjectById(examSubject.getId());
    ...
    // } else {
    // return Global.createErrorMessage("Not authorized to update this exam
    // subject");
    // }
    // }
    // }
    ...
    // } else {
    // return Global.createErrorMessage("Not authorized to delete this exam
    // subject");
    // }
    // }
    // }
